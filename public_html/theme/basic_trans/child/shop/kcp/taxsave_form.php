...
<script>
    ...
    function  jsf__chk_cash( form )
    {
        ...
        {
            alert("<?php echo _('원 거래 시각을 정확히 입력해 주시기 바랍니다.') ?>");
        ...
        if ( form.corp_type.value == "1" )
        {
            ...
            {
                alert("<?php echo _('발행 사업자번호를 정확히 입력해 주시기 바랍니다.') ?>");
        ...
        if (  form.tr_code[0].checked )
        {
            ...
            {
                alert("<?php echo _('주민번호 또는 휴대폰번호를 정확히 입력해 주시기 바랍니다.') ?>");
                form.id_info.select();
                form.id_info.focus();
                return false;
            }
        ...
        else if (  form.tr_code[1].checked )
        {
            if ( form.id_info.value.length != 10 )
            {
                alert("<?php echo _('사업자번호를 정확히 입력해 주시기 바랍니다.') ?>");
                form.id_info.select();
                form.id_info.focus();
                return false;
            }
...
<div id="scash" class="new_win">
    ...
    <section>
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tbody>
            <tr>
                <th scope="row"><?php echo _('주문 번호') ?></th>
                <td><?php echo $od_id; ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('상품 정보') ?></th>
                <td><?php echo $goods_name; ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('주문자 이름') ?></th>
                <td><?php echo $od_name; ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('주문자 E-Mail') ?></th>
                <td><?php echo $od_email; ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('주문자 전화번호') ?></th>
    ...
    <section>
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tbody>
            <tr>
                <th scope="row"><?php echo _('원 거래 시각') ?></th>
                <td><?php echo $trad_time; ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('발행 용도') ?></th>
                <td>
                    <input type="radio" name="tr_code" value="0" id="tr_code1" onClick="jsf__chk_tr_code( this.form )" checked>
                    <label for="tr_code1"><?php echo _('소득공제용') ?></label>
                    <input type="radio" name="tr_code" value="1" id="tr_code2" onClick="jsf__chk_tr_code( this.form )">
                    <label for="tr_code2"><?php echo _('지출증빙용') ?></label>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="id_info">
                        <span id="span_tr_code_0" style="display:inline"><?php echo _('주민(휴대폰)번호') ?></span>
                        <span id="span_tr_code_1" style="display:none"><?php echo _('사업자번호') ?></span>
                    </label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row"><?php echo _('거래금액 총합') ?></th>
                <td><?php echo number_format($amt_tot); ?><?php echo _('원') ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('공급가액') ?></th>
                <td><?php echo number_format($amt_sup); ?><?php echo _('원') ?><!-- ((거래금액 총합 * 10) / 11) --></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('봉사료') ?></th>
                <td><?php echo number_format($amt_svc); ?><?php echo _('원') ?></td>
            </tr>
            <tr>
                <th scope="row"><?php echo _('부가가치세') ?></th>
                <td><?php echo number_format($amt_tax); ?><?php echo _('원') ?><!-- 거래금액 총합 - 공급가액 - 봉사료 --></td>
            </tr>
            </tbody>
            </table>
        </div>
        ...
        <div id="scash_apply">
            <span id="show_pay_btn">
                <button type="button" onclick="jsf__pay_cash( this.form )"><?php echo _('등록요청') ?></button>
            </span>
            <span id="show_progress" style="display:none">
                <b><?php echo _('등록 진행중입니다. 잠시만 기다려주십시오') ?></b>
            </span>
        </div>
