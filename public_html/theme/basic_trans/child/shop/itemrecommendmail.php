...
if (substr_count($to_email, "@") > 1) alert(_('메일 주소는 하나씩만 입력해 주십시오.'));

if ($_SESSION["ss_recommend_datetime"] >= (G5_SERVER_TIME - 120))
    alert(_("너무 빠른 시간내에 메일을 연속해서 보낼 수 없습니다."));
...
if ($recommendmail_count > 3)
    alert_close(_('한번 접속후 일정수의 메일만 발송할 수 있습니다.').'\\n\\n'._('계속해서 메일을 보내시려면 다시 로그인 또는 접속하여 주십시오.'));
...
if ($_POST["token"] && get_session("ss_token") == $_POST["token"]) {
    ...
    alert_close(_("메일 발송시 오류가 발생하였습니다."));
    exit;
}
