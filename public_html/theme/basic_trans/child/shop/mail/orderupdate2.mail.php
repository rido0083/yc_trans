...
<head>
<meta charset="utf-8">
<title><?php echo $config['cf_title']; ?> <?php echo _('- 주문 알림 메일') ?></title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?php echo $config['cf_title'];?> <?php echo _('- 주문이 접수되었습니다.') ?>
        </h1>

        <p style="<?php echo $cont_st; ?>">
            <strong><?php echo _('주문번호') ?> <?php echo $od_id; ?></strong><br>
            <?php echo _('본 메일은') ?> <?php echo G5_TIME_YMDHIS; ?> (<?php echo get_yoil(G5_TIME_YMDHIS); ?>)<?php echo _('을 기준으로 작성되었습니다.') ?>
        </p>

        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>"> <?php echo _('주문 내역') ?></caption>
        <colgroup>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('상품명') ?></th>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('판매가격') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_price($list[$i]['ct_price']); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('선택옵션') ?> </th>
            <td style="<?php echo $td_st; ?>"><?php echo $list[$i]['it_opt']; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('소계') ?></th>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('배송비') ?></th>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('추가배송비') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_price($od_send_cost2); ?></td>
        </tr>
        <?php } ?>

        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('주문합계') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_price($ttotal_price); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('포인트합계') ?></th>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>"><?php echo _('결제정보') ?></caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('포인트 입금액') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_point($od_receipt_point); ?></td>
        </tr>
        <?php } ?>

        <?php if ($od_receipt_price > 0 && $od_settle_case == _('신용카드')) { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('신용카드 입금액') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_price($od_receipt_price); ?></td>
        </tr>
        <?php } ?>

        <?php if ($od_receipt_price > 0 && $od_settle_case == _('계좌이체')) { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo $od_settle_case; ?> <?php echo _('입금액') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo display_price($od_receipt_price); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('계좌번호') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_bank_account; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('입금자 이름') ?></th>
        ...
        <tr>
            <td colspan="2" style="<?php echo $empty_st; ?>"><?php echo _('결제정보가 없습니다.') ?></td>
        </tr>
        <?php } ?>
        </tbody>
        </table>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>"><?php echo _('주문하신 분 정보') ?></caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        <tbody>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('이름') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_name; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('전화번호') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_tel; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('핸드폰') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_hp; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('주소') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo sprintf("(%s%s)", $od_zip1, $od_zip2).' '.print_address($od_addr1, $od_addr2, $od_addr3, $od_addr_jibeon); ?></td>
        </tr>

        <?php if ($od_hope_date) { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('희망배송일') ?></th>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>"><?php echo _('배송지 정보') ?></caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        <tbody>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('이 름') ?></th>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>"><?php echo _('전하실 말씀') ?></th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_memo; ?></td>
        </tr>
        </tbody>
        </table>

        <p style="<?php echo $cont_st; ?>"><?php echo _('배송지를 변경하실 고객님은 ') ?><b><?php echo  $default['de_admin_company_tel']; ?></b><?php echo _('로 연락주시기 바랍니다.') ?></p>

        <a href="<?php echo G5_SHOP_URL.'/orderinquiry.php'; ?>" target="_blank" style="<?php echo $ft_a_st; ?>"><?php echo _('주문상세내역 확인') ?></a>
