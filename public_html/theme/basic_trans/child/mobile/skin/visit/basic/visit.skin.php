...
<aside id="visit">
    ...
    <?php if ($is_admin == "super") { ?><a href="<?php echo G5_ADMIN_URL ?>/visit_list.php" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only"><?php echo _('상세보기') ?></span></a></a><?php } ?>
</aside>
