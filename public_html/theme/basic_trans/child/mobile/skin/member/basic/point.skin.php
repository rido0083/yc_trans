    ...
    //            if($row['po_expired'] == 1)
            ...
            <li class="<?php echo $point_use_class; ?>">
                ...
                <span class="point_date<?php echo $expr; ?>">
                    ...
                    <?php echo _('만료') ?> <?php echo substr(str_replace('-', '', $row['po_expire_date']), 2); ?>
            ...
            if ($i == 0)
                echo '<li class="empty_list">'._('자료가 없습니다.').'</li>';
            else {
                if ($sum_point1 > 0)
        ...
        <button type="button" onclick="javascript:window.close();" class="btn_close"><?php echo _('창닫기') ?></button>
    </div>
</div>