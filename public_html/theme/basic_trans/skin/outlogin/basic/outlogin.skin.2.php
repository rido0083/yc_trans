...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="ol_after_info" title="정보수정"><?php echo _('정보수정') ?></a>
    ...
    <footer>
    	<a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo _('로그아웃') ?></a>
    </footer>
</section>
