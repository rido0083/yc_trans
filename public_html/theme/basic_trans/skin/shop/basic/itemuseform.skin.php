...
<div id="sit_use_write" class="new_win">
    ...
    <div class="new_win_con form_01">
        <ul>
            <li>
                <label for="is_subject" class="sound_only"><?php echo _('제목') ?><strong> <?php echo _('필수') ?></strong></label>
                <input type="text" name="is_subject" value="<?php echo get_text($use['is_subject']); ?>" id="is_subject" required class="required frm_input full_input"  maxlength="250" placeholder="<?php echo _('제목') ?>">
            </li>
            <li>
                <strong  class="sound_only"><?php echo _('내용') ?></strong>
                <?php echo $editor_html; ?>
            </li>
            <li>
                <span class="sound_only"><?php echo _('평점') ?></span>
                <ul id="sit_use_write_star" class="chk_box">
                    <li>
                        ...
                        <label for="is_score5"><span></span><?php echo _('매우만족') ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score4"><span></span><?php echo _('만족') ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score3"><span></span><?php echo _('보통') ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score2"><span></span><?php echo _('불만') ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score1"><span></span><?php echo _('매우불만') ?></label>
