...
<div id="faq_sch">
    ...
    <button type="submit" value="검색" class="btn_submit"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only"><?php echo _('검색') ?></span></button>
    </form>
</div>
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <?php
        ...
        if($stx){
            ...
            echo '<div class="empty_table">'._('등록된 FAQ가 없습니다.');
            if($is_admin)
                echo '<br><a href="'.G5_ADMIN_URL.'/faqmasterlist.php">'._('FAQ를 새로 등록하시려면 FAQ관리</a> 메뉴를 이용하십시오.');
            echo '</div>';
        }
    }
    ?>
