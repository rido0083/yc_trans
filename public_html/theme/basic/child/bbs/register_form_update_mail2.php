...
<head>
<meta charset="utf-8">
<title><?php echo _('회원가입 알림 메일') ?></title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <p style="margin:20px 0 0;padding:30px 30px 50px;min-height:200px;height:auto !important;height:200px;border-bottom:1px solid #eee">
            <b><?php echo $mb_name ?></b> <?php echo _('님께서 회원가입 하셨습니다.') ?><br>
            <?php echo _('회원 아이디 :') ?> <b><?php echo $mb_id ?></b><br>
            <?php echo _('회원 이름 :') ?> <?php echo $mb_name ?><br>
            <?php echo _('회원 닉네임 :') ?> <?php echo $mb_nick ?><br>
            <?php echo _('추천인 아이디 :') ?> <?php echo $mb_recommend ?>
        </p>
