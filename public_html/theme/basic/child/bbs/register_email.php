...
if (substr($mb['mb_email_certify'],0,1)!=0) {
    alert(_("이미 메일인증 하신 회원입니다."), G5_URL);
}
...
if(!$ckey || $ckey != $key)
    alert(_('올바른 방법으로 이용해 주십시오.'), G5_URL);
?>

<p class="rg_em_p"><?php echo _('메일인증을 받지 못한 경우 회원정보의 메일주소를 변경 할 수 있습니다.') ?></p>
...
<div class="tbl_frm01 tbl_frm rg_em">
    <table>
    <caption><?php echo _('사이트 이용정보 입력') ?></caption>
    <tr>
    ...
    <tr>
        <th scope="row"><?php echo _('자동등록방지') ?></th>
