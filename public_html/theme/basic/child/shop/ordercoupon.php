...
if($price <= 0)
    die(_('상품금액이 0원이므로 쿠폰을 사용할 수 없습니다.'));
    ...
    <div id="od_coupon_frm" class="od_coupon">
        ...
        <div class="tbl_head02 tbl_wrap">
            ...
            <tr>
                ...
                <td class="td_mngsmall"><button type="button" class="od_cp_apply btn_frmline"><?php echo _('적용') ?></button></td>
            </tr>
            <?php
            }
            ?>
        ...
        <div class="btn_confirm">
            <button type="button" id="od_coupon_close" class="btn_close"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only"><?php echo _('닫기') ?></span></button>
        </div>
    </div>
</div>
<!-- } 쿠폰 선택 끝 -->