...
<div id="sit_rec_new" class="new_win">
    ...
    <div class="tbl_wrap">
        <table>
	        <tbody>
	        <tr>
	            <th><label for="to_email"><?php echo _('추천받는 분') ?><br>E-mail<strong class="sound_only"> <?php echo _('필수') ?></strong></label></th>
	            <td><input type="text" name="to_email" id="to_email" required class="frm_input full_input required" size="51"></td>
	        </tr>
	        <tr>
	            <th><label for="subject"><?php echo _('제목') ?><strong class="sound_only"> <?php echo _('필수') ?></strong></label></th>
	            <td><input type="text" name="subject" id="subject" required class="frm_input full_input required" size="51"></td>
	        </tr>
	        <tr>
	            <th><label for="content"><?php echo _('내용') ?><strong class="sound_only"> <?php echo _('필수') ?></strong></label></th>
    ...
    <div class="win_btn">
        <button type="submit" id="btn_submit" class="btn_submit"><?php echo _('보내기') ?></button>
        <button onclick="javascript:window.close();" class="btn_close"><?php echo _('닫기') ?></button>
    </div>
