...
if (!G5_IS_MOBILE && $is_admin)
    echo '<div class="sct_admin"><a href="'.G5_ADMIN_URL.'/shop_admin/couponzonelist.php" class="btn_admin btn"><span class="sound_only">'._('쿠폰존 관리').'</span><i class="fa fa-cog fa-spin fa-fw"></i></a></div>';
