...
<section id="sod_frm_escrow">
    ...
    <tr>
        <td>
            <strong><?php echo _('에스크로(escrow) 제도란?') ?></strong>
            <p>
                <?php echo _('상거래 시에, 판매자와 구매자의 사이에 신뢰할 수 있는 중립적인 제삼자(여기서는') ?> <a href='http://kcp.co.kr' target='_blank'>KCP</a>)<?php echo _('가 중개하여 금전 또는 물품을 거래를 하도록 하는 것, 또는 그러한 서비스를 말한다. 거래의 안전성을 확보하기 위해 이용된다. (2006.4.1 전자상거래 소비자보호법에 따른 의무 시행)') ?>
            </p>
            <p>
            <?php echo _('현금 거래에만 해당(에스크로 결제를 선택했을 경우에만 해당)되며,
