...
<section id="sit_qa_list">
    <h3><?php echo _('등록된 상품문의') ?></h3>

    <div id="sit_qa_wbtn">
        <a href="<?php echo $itemqa_form; ?>" class="btn02 itemqa_form"><?php echo _('상품문의 쓰기') ?><span class="sound_only"><?php echo _('새 창') ?></span></a>
