...
<section id="s_ol_after" class="ol">
    <header id="s_ol_after_hd">
        ...
        <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="s_ol_after_info"><?php echo _('정보수정') ?></a>
        <a href="<?php echo G5_BBS_URL ?>/logout.php" id="s_ol_after_logout"><?php echo _('로그아웃') ?></a>
    </header>
    <ul id="s_ol_after_private">
        ...
        <li>
        	<a href="<?php echo G5_SHOP_URL ?>/coupon.php" target="_blank" class="win_coupon">
        		<i class="fa fa-ticket" aria-hidden="true"></i></i><?php echo _('쿠폰') ?>
        ...
        <li>
            <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" id="ol_after_memo" class="win_memo">
            	<i class="fa fa-envelope-o" aria-hidden="true"></i><span class="sound_only"></i><?php echo _('안 읽은') ?> </span><?php echo _('쪽지') ?>
