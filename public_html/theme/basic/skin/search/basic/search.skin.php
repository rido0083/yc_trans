...
<div id="sch_result">
    ...
    <section id="sch_res_ov">
        <h2><strong><?php echo $stx ?></strong> <?php echo _('전체검색 결과') ?></h2>
        <ul>
            <li><?php echo _('게시판') ?> <?php echo $board_count ?><?php echo _('개') ?></li>
            <li><?php echo _('게시물') ?> <?php echo number_format($total_count) ?><?php echo _('개') ?></li>
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
		...
		<a href="<?php echo get_pretty_url($search_table[$idx], '', $search_query); ?>" class="sch_more"><?php echo _('더보기') ?></a>
        <ul>
        <?php
         ...
         ?>
            ...
            <li>
                <div class="sch_tit">
                    ...
                    <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" target="_blank" class="pop_a"><i class="fa fa-window-restore" aria-hidden="true"></i><span class="sound_only"><?php echo _('새창') ?></span></a>
                </div>
