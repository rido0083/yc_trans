...
<div id="sod_fin">
    ...
    <section id="sod_fin_list">
        ...
        <div class="tbl_head03 tbl_wrap">
			<table>
	            <thead>
	            <tr class="th_line">
	            	<th scope="col" id="th_itname"><?php echo _('상품명') ?></th>
	                <th scope="col" id="th_itqty"><?php echo _('총수량') ?></th>
	                <th scope="col" id="th_itprice"><?php echo _('판매가') ?></th>
	                <th scope="col" id="th_itpt"><?php echo _('포인트') ?></th>
	                <th scope="col" id="th_itsd"><?php echo _('배송비') ?></th>
	                <th scope="col" id="th_itsum"><?php echo _('소계') ?></th>
        ...
        <div id="sod_sts_wrap">
            <span class="sound_only"><?php echo _('주문번호') ?></span>
    ...
    <div class="sod_right">
        <ul id="sod_bsk_tot2">
            ...
            <li class="sod_fin_tot"><span><?php echo _('총 구매액') ?></span><strong><?php echo display_price($tot_price); ?></strong></li>
            <?php
            if ($misu_price > 0) {
            echo '<li class="sod_fin_tot">';
            echo '<span>'._('미결제액').'</span>'.PHP_EOL;
            echo '<strong>'.display_price($misu_price).'</strong>';
            echo '</li>';
            }
            ?>
            <li id="alrdy" class="sod_fin_tot">
            	<span><?php echo _('결제액') ?></span>
                <strong><?php echo $wanbul; ?></strong>
                <?php if( $od['od_receipt_point'] ){    //포인트로 결제한 내용이 있으면 ?>
                <div>
                    <p><span class="title"><?php echo _('포인트 결제') ?></span><?php echo number_format($od['od_receipt_point']); ?><?php echo _('점') ?></p>
                    <p><span class="title"><?php echo _('실결제') ?></span><?php echo number_format($od['od_receipt_price']); ?><?php echo _('원') ?></p>
                </div>
                <?php } ?>
            </li>
        </ul>
        ...
        <section id="sod_fin_pay">
            ...
            <ul>
	            ...
	            ?>
	            <li>
	                <strong><?php echo _('입금자명') ?></strong>
	                <span><?php echo get_text($od['od_deposit_name']); ?></span>
	            </li>
	            <li>
	                <strong><?php echo _('입금계좌') ?></strong>
	            ...
	            ?>
	            <li>
	                <strong><?php echo _('포인트사용') ?></strong>
	            ...
	            ?>
	            <li>
	                <strong><?php echo _('환불 금액') ?></strong>
	            ...
	            ?>
	            <li>
	                <strong class="letter-2px"><?php echo _('현금영수증') ?></strong>
	                <span>
	                <?php
	                if ($od['od_cash'])
	                {
	                ...
	                {
	                ?>
	                    <a href="javascript:;" onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');" class="btn_frmline is-long-text"><?php echo _('현금영수증을 발급하시려면 클릭하십시오.') ?></a>
	                <?php } ?>
	                </span>
	            </li>
            <?php
        ...
        <section id="sod_fin_cancel">
            ...
            if ($cancel_price == 0) {
                if ($custom_cancel) {
            ?>
            <button type="button" class="sod_fin_c_btn"><?php echo _('주문 취소하기') ?></button>
			<div id="sod_cancel_pop">	
	            <div id="sod_fin_cancelfrm">
	                ...
	                <button class="sod_cls_btn"><span class="sound_only"><?php echo _('닫기') ?></span><i class="fa fa-times" aria-hidden="true"></i></button>
		        </div>
